...
public class SpeedyTiltShift {
    ...
    public static Bitmap tiltshift_java(Bitmap input, float sigma_far, float sigma_near, int a0, int a1, int a2, int a3, String method){
        ...
        // Calling vector method if vector method is called
        if(method.equals("Vector Method"))
            return SpeedyTiltShiftVector.tiltshift_java(input, sigma_far, sigma_near, a0, a1, a2, a3);
